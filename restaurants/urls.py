...
urlpatterns = [
    ...
    path('<str:eatery>/preview/menu/', views.preview_menu, name='preview_menu'),
    path('<str:eatery>/preview/events/', views.preview_events, name='preview_events'),
    path('<str:eatery>/preview/about/', views.preview_about, name='preview_about'),
